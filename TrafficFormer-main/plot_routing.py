...
draw_heatmap(
    ...
    "routing_heatmap_v1_4e_adapter+backbone_top2_ISCX-VPN-Service-share-seed=21.png",
)
...
for rank_id, matrix in enumerate(rank_routing_matrices):
    draw_heatmap(
        ...
        f"routing_heatmap_rank{rank_id + 1}_v1_4e_adapter+backbone_top2_ISCX-VPN-Service-share-seed=21.png",
    )
...
if len(rank_routing_matrices) > 1:
    draw_rank_grid(
        ...
        class_names,
        num_experts,
        "routing_heatmap_ranks_v1_4e_adapter+backbone_top2_ISCX-VPN-Service-share-seed=21.png",
    )
